...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textView_datePicker.setOnClickListener {
            ...
            val dpd = DatePickerDialog(this,
                DatePickerDialog.OnDateSetListener {
                    view, year, month, day ->
                     textView_datePicker.setText(day.toString() + "/" + (month + 1).toString() + "/" + year.toString())
                     dobYear = year
                     display(currentYear, dobYear)
                     textView_datePicker.setTextColor(Color.BLACK)
    ...
    private fun display(cYear: Int, year: Int) {
        ...
        textView_age.setText(age.toString())
        textView_basicSaving.setText(basicSaving.toString())
        textView_allowableInvestment.setText(allowableInvestment.toInt().toString())
    }
